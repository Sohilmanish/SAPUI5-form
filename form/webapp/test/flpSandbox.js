		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Form",
									"targetURL": "#commanishform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commanishform-display": {
								"semanticObject": "commanishform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.manish.form",
									"url": sap.ui.require.toUrl("com/manish/form")
								}
							}
						}
					}
